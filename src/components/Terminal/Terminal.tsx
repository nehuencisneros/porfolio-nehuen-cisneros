            ...
            <div className={style.divTerminalContainer}>
               ...
               <div className={style.cajaTerminal}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "start", paddingInline: "2rem" }}>
                     ...
                     <h4><h5 className={style.commandLine}>Nehuen@Desktop {'> '}</h5>Soy un meticuloso y responsable desarrollador IT, que a fines de 2021 comenzó su camino estudiando informática.
                     ...
                     <h5 className={style.commandLine}>Seleccione</h5>
